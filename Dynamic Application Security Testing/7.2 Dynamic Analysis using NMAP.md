...
```
nmap prod-6jnpiomi -oX nmap_out.xml
**Output**
Starting Nmap 7.60 ( https://nmap.org ) at 2021-05-03 07:37 UTC
Nmap scan report for prod-6jnpiomi (x.x.x.x)
Host is up (0.000027s latency).
rDNS record for x.x.x.x: prod-6jnpiomi.6jnpiomi
...
<!-- Nmap 7.60 scan initiated Tue Mar 23 12:02:33 2021 as: nmap -oX nmap_out.xml prod-6jnpiomi -->
<nmaprun scanner="nmap" args="nmap -oX nmap_out.xml prod-6jnpiomi" start="1616500953" startstr="Tue Mar 23 12:02:33 2021" version="7.60" xmloutputversion="1.
04">
...
<hostnames>
<hostname name="prod-6jnpiomi" type="user"/>
<hostname name="prod-6jnpiomi.lab" type="PTR"/>
</hostnames>

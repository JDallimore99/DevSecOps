...
Install SSLyze to perform Dynamic Analysis
```
...
> Note, we are using the target as prod-6jnpiomi.lab.practical-devsecops.training:443
```
sslyze --json_out sslyze-output.json prod-6jnpiomi.lab.practical-devsecops.training:443
**Output**
 CHECKING CONNECTIVITY TO SERVER(S)
 ----------------------------------

   prod-6jnpiomi.lab.practical-devsecops.training:443 => x.x.x.x

 SCAN RESULTS FOR PROD-6jnpiomi.lab.practical-devsecops.training:443 - x.x.x.x
 ---------------------------------------------------------------------------------------

 * Certificates Information:
       Hostname sent for SNI:             prod-6jnpiomi.lab.practical-devsecops.training
 ...
 * Elliptic Curve Key Exchange:
 ...
 --------------------------------------------
    ...
    prod-6jnpiomi.lab.practical-devsecops.training:443: FAILED - Not compliant.
...
...[SNIP]...
            ...
            "server_location": {
                ...
                "hostname": "prod-6jnpiomi.lab.practical-devsecops.training",
